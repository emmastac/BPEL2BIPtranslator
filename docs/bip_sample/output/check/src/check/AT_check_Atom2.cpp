...
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:65:27
        _id__c = (_id__c)  +  (1);
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:65:34
        printf("[name:Atom2,place:B,c:%d,d:%d],", _id__c, _id__d);

// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:65:1
        if (! fromA()) {
...
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:66:27
        _id__d = (_id__d)  +  (1);
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:66:34
        printf("[name:Atom2,place:C,c:%d,d:%d]", _id__c, _id__d);

// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:66:1
        if (! fromA()) {
            NonOneSafePetriNetError *r = new NonOneSafePetriNetError(*this);
            r->setPort(_iport_decl__AtoC);
            return *r;
...
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:67:27
        _id__d = (_id__d)  +  (1);
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:67:34
        printf("[name:Atom2,place:B,c:%d,d:%d]", _id__c, _id__d);

// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:67:1
        if (! fromC()) {
            NonOneSafePetriNetError *r = new NonOneSafePetriNetError(*this);
            r->setPort(_iport_decl__CtoB);
            return *r;
...
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:68:26
        _id__c = 0;
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:68:31
        _id__d = 0;
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:68:35
        printf("[name:Atom2,place:A,c:%d,d:%d]", _id__c, _id__d);

// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:68:1
        if (! fromB()) {
            NonOneSafePetriNetError *r = new NonOneSafePetriNetError(*this);
            r->setPort(_iport_decl__BtoA);
            return *r;
...
BipError& AT_check_Atom2::initialize() {
    ...
    // initial action
// /home/dsg003/Dropbox/eclipse_workspace/BIP2LATEX_revised2/docs/bip_sample/check.bip:64:19
    printf("[name:Atom2,place:A,c:%d,d:%d]", _id__c, _id__d);
