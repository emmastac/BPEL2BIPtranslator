#ifndef CHECK_CONNT__CHECK__RDV2_HPP_
#define CHECK_CONNT__CHECK__RDV2_HPP_
...
class ConnT_check_RDV2 : public Connector {
public:
    ConnT_check_RDV2(const string &name, QPR_check_e0b0port &p1, QPR_check_e0b0port &p2);
    virtual ~ConnT_check_RDV2();
...
#endif // CHECK_CONNT__CHECK__RDV2_HPP_
